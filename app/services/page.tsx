...
const globalCss = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  ul.gallery-scroll {
    ...
    padding-inline: calc(50% - (var(--gallery-card-min)) * 0.5);
    margin: 0;
    cursor: grab;
  ...
  ul.gallery-scroll li {
    position: relative;
    flex-shrink: 0;
    display: flex;
    align-items: flex-end;
    justify-content: center;
    width: var(--gallery-card-min);
    aspect-ratio: 487 / 582;
    scroll-snap-align: center;
    animation: gallery-grow both
      linear(
        0 0%, 0.0027 3.64%, 0.0106 7.29%, 0.0425 14.58%, 0.0957 21.87%,
        0.1701 29.16%, 0.2477 35.19%, 0.3401 41.23%, 0.5982 55.18%,
        0.7044 61.56%, 0.7987 68.28%, 0.875 75%, 0.9297 81.25%,
        0.9687 87.5%, 0.9922 93.75%, 1 100%
      );
    animation-timeline: view(inline);
  }

  @keyframes gallery-grow {
    50% { width: var(--gallery-card-max); }
  }
...
export default function ServicesPage() {
  ...
  useEffect(() => {
    ...
    const updateScroll = function (this: Draggable) {
      list.scrollLeft = (this as any).scrollLeft + -this.x;
    };
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 10 }}>
          ...
          >
            ...
            >
              Tailored Treatments for Your Unique Glow
            </h1>
            ...
            >
              Experience a symphony of precision and luxury.
              <br />
              Our services are tailored to the individual, utilizing the world&apos;s most
              exclusive botanical formulas and advanced styling techniques.
            </p>
          </div>
              ...
              {GENDER_OPTIONS.map((opt) => {
                ...
                return (
                  <button
                    ...
                    className={`gender-tab ${isActive ? 'gender-tab-active' : 'gender-tab-inactive'}`}
                    style={{
          ...
          >
            <div
              className={`category-tabs-wrap ${categoryVisible ? 'reveal-up' : ''}`}
              style={{
          ...
          <div
            ref={priceRef}
            style={{
              padding: 'clamp(1rem, 3vw, 2rem) clamp(1.25rem, 5vw, 4rem) clamp(3rem, 6vw, 5rem)',
            }}
          >
